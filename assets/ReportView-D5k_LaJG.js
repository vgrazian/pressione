...
`,t+=`--- CATEGORIE ---
`;for(const[g,u]of Object.entries(e.categoryDistribution||{})){const E=(u/e.readingsCount*100).toFixed(1);t+=`${z(g)}: ${u} (${E}%)
`}t+=`
