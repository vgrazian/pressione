  ...
  <div class="page">
    ...
    <div class="card mb-md">
      ...
      <div class="flex gap-sm">
        <button class="chip" :class="{ 'chip--active': currentLang === 'it' }" @click="changeLanguage('it')">Italiano</button>
        <button class="chip" :class="{ 'chip--active': currentLang === 'en' }" @click="changeLanguage('en')">English</button>
      </div>
    </div>
